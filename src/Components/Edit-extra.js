            ...
            <form action="" className="form" onSubmit={this.props.handleSubmit(this.onsubmit)}>
                <div className="form-row">
                    ...
                    <div className="col-12">
                        <Field maxLength="40" name="title" type="text" className="form-control" component={this.input} placeholder="Enter extra item" />
                    </div>
                    ...
                    <div className="col-12">
                        <Field maxLength="40" name="category" type="text" className="form-control" component={this.input} placeholder="Enter category" />
                    </div>     
                </div>
...
const mapStateToProps=(state,ownprops)=>{
    ...
    {   if(state.view.length>0)
        {
            return {initialValues: {title: state.view[0].title,price: state.view[0].price,category: state.view[0].category,message: []} }
        }

    }
    return
}
export default connect(mapStateToProps,{viewcat,editcat})(reduxForm({form: 'ExtraCreate',enableReinitialize: true})(Edit));